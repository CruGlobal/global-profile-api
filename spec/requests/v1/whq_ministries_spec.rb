...
RSpec.describe 'V1::WhqMinistries', type: :request do
  let(:json) { JSON.parse(response.body) }
  describe 'GET /whq_ministries' do
    context 'without a session' do
      it 'responds with HTTP 401' do
        get '/v1/whq_ministries'
    ...
    context 'with a session' do
      it 'responds with all active ministries' do
        ...
        get '/v1/whq_ministries', nil, 'HTTP_AUTHORIZATION' => "Bearer #{authenticate_guid}"
      ...
      context 'show_inactive=true' do
        it 'responds with all ministries including inactive ones' do
          ...
          get '/v1/whq_ministries?show_inactive=true', nil, 'HTTP_AUTHORIZATION' => "Bearer #{authenticate_guid}"
      ...
      context 'global_profile_only=true' do
        it 'responds with only global profile ministries' do
          ...
          get '/v1/whq_ministries?global_profile_only=true', nil, 'HTTP_AUTHORIZATION' => "Bearer #{authenticate_guid}"
      ...
      context 'refresh=true' do
        it 'reload ministries from global registry' do
          ...
          get '/v1/whq_ministries?refresh=true', nil, 'HTTP_AUTHORIZATION' => "Bearer #{authenticate_guid}"
