...
RSpec.describe 'V1::IsoCountries', type: :request do
  let(:json) { JSON.parse(response.body) }
  describe 'GET /v1/iso_countries' do
    context 'without a session' do
      it 'responds with HTTP 401' do
        get '/v1/iso_countries'
    ...
    context 'with a session' do
      it 'responds with all countries' do
        ...
        get '/v1/iso_countries', nil, 'HTTP_AUTHORIZATION' => "Bearer #{authenticate_guid}"
